<template>
    <div id="how-to" class="position-relative">
        <img src="../../public/images/artist-shape-01-600x577.png" alt="">
        <img class="line" src="../../public/images/maxcoach-shape-14-1536x343.png" alt="">
...
<script>
import CardHowToComp from './HowToCards/CardHowToComp.vue';
